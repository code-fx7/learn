...
import { CharterFlight } from './charter-flights';
...
// Gleichbedeutende Alternative: const namen: Array<sting> = ['Max', 'Susi'];
...
const flight: Flight = {
  ...
  from: 'Graz',
  to: 'Hamburg',
  date: '2018-12-24T17:00:00.001:00'
};
...
console.debug('is Person', isPerson);
...
console.debug('a1 as full Adress', a1.fullAddress());

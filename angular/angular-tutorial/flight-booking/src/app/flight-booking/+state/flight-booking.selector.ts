...
export const selectFlightBookingState = createFeatureSelector<fromFlightBooking.FlightBookingAppState>(
...
// eslint-disable-next-linde prefer-arrow/prefer-arrow-functions

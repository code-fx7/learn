...
import { cityWithParamsValidator } from 'asr/app/shared/validation/reactive/city-with-params-validator';
...
export class FlightEditComponent {
  ...
  constructor(
    ...
    this.categoriesFormArray = fb.group({
      from: [
        'Graz',
        [
          Validators.required,
    ...
    this.formGroup.statusChanges.subscribe(
      value => console.debug('whole from changed', value)
    );
  }
decided(decision: boolean): void {
